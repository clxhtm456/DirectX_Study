#include "stdafx.h"
#include "ProjecterDemo.h"
#include "Viewer/Freedom.h"
#include "Environment/Terrain.h"
#include "Environment/SkyCube.h"

void ProjecterDemo::Initialize()
{
	...
	shader = new Shader(L"42_Projector.fx");
...
void ProjecterDemo::Destroy()
{
	SafeDelete(shader);
	SafeDelete(sky);	
}

void ProjecterDemo::Update()
{	
...
void ProjecterDemo::CreateViewer()
{
	//Main
...
void ProjecterDemo::AddPointLights()
{
	PointLight light;
	light =
	{
...
void ProjecterDemo::AddSpotLights()
{
	SpotLight light;
	light =
	{
...
void ProjecterDemo::Pass(UINT mesh, UINT model, UINT anim)
{
